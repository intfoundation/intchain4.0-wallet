export default {
    ...
    pleaseUnlockAccount: 'Please unlock account',
    staking: 'Staking',
    register: 'Register',
    unRegister: 'UnRegister',
    editValidator: 'EditValidator',
    intandethBridge: 'INT<->ETH',
    intandbscBridge: 'INT<->BSC',
    ethandbscBridge: 'ETH<->BSC',
    errPublicKey: 'The public key is incorrect',
    errCommission: 'The commission is incorrect',
    ...
    etnpwd2: 'Please select a new wallet Keystor',
    ...
    errAmount: 'The amount is incorrect',
    errLimit: 'Gas Limit is incorrect',
    errLimitLess: 'Gas Limit can not less than 21000',
    errPrice: 'Gas Price is incorrect',
    errPriceBig: 'Gas Price can not bigger than 0.0005',
    ...
    receiveAddr: 'Receive Address(INT Chain 3.0 Address)',
