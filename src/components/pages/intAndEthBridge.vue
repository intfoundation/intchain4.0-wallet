    ...
    <div v-if="step == 2" style="padding-bottom: 90px">
      ...
      <div class="box">
        <div style="margin: 48px 0 0 108px">
          <div class="item">
            <p style="font-size: 18px">{{isINTToETH ? "INT Chain" : "Ethereum"}}</p>
<!--            <el-input-->
<!--              style="width: 420px"-->
<!--              v-model="address"-->
<!--            ></el-input>-->
          ...
          <div class="item">
            <p style="font-size: 18px">{{isINTToETH ? "Ethereum" : "INT Chain"}}</p>
<!--            <el-input-->
<!--              style="width: 420px"-->
<!--              v-model="balance"-->
<!--            ></el-input>-->
          ...
          <div class="item">
            <p style="font-size: 14px">{{isINTToETH ? "INT" : "ETH"}} {{ $t("balance") }}</p>
            <el-input
              style="width: 420px"
              readonly
              v-model="balance"
...
export default {
  ...
  methods: {
    changeDirection() {
      console.log("is INT to ETH", this.isINTToETH, this.fromCoin, this.toCoin)
      this.isINTToETH = !this.isINTToETH;
      [this.fromCoin, this.toCoin] = [this.toCoin, this.fromCoin];
      console.log("is INT to ETH", this.isINTToETH, this.fromCoin, this.toCoin)
      let list = this.isINTToETH ? this.intList : this.ethList;
